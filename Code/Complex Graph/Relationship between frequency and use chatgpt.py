...
plt.xlabel("How often do you use ChatGPT")
plt.ylabel("Number of People")
plt.legend(["Aid in Assignment", "Self Study", "Summarizing Tool", "To Explore", "Other"])
plt.title("Relationship Between Frequency and the Ways ChatGPT is used", fontweight = 'bold', x = 0.5, y = 1.05, size = 'xx-large')
plt.show()
